...
public class Informacion extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (lang == "en") {
			...
			tv6.setText("Special thanks to http://theandroidcoder.com/utilities/android-image-download-and-caching for their class to download and cache images.");
			...
			tv6.setText("Agradecimientos especiales a http://theandroidcoder.com/utilities/android-image-download-and-caching por su clase para descargar y cachear imágenes.");
