...
@SuppressLint("NewApi")
public class UltimosMoviles extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			if (comprobarConectividad()) {
				String[] params = { "nombres_moviles_iddesc" };
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_info:
			Intent i = new Intent(UltimosMoviles.this, Informacion.class);
			startActivity(i);
			return true;
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {	
		...
		String[] pieces = textItem.split(" - ");
		// Redireccion a la pagina de detalles del movil
		Intent intent = new Intent(UltimosMoviles.this, UnMovil.class);
		intent.putExtra("MOVIL", pieces[0]);
		startActivity(intent);
	}
