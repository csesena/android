	...
	public ArrayList<String> sacamosDatos(String[] params, String moneda) {
		...
		try {
			...
			HttpGet httpget = new HttpGet(
					"http://marketplace.sanchezsesena.com/Android/mc.php?user=lolation&pass=lolat");
			if (params[0].equals("nombres_moviles")) {
				httpget = new HttpGet(
						"http://marketplace.sanchezsesena.com/Android/mc.php?user=lolation&pass=lolation&tipo_funcion="
								+ params[0]);
			} else if (params[0].equals("nombres_moviles_iddesc")) {
				String urlget = "http://marketplace.sanchezsesena.com/Android/mc.php?user=lolation&pass=lolation&tipo_funcion="
						+ params[0];
