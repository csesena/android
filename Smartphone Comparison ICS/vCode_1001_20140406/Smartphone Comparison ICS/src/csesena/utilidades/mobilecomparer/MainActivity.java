...
import csesena.utilidades.mobilecomparer.adapters.CustomCompeticionArrayAdapter;
...
public class MainActivity extends Activity {
	...
	// Método para cmabiar el título de la barra de acción
	@Override
	...
	// Método para introducir la información de las competiciones recogida en BD
	// en la interfaz
	public void fillOptions() {
		...
		if (mopciones != null)
			mDrawerList.setAdapter(new CustomCompeticionArrayAdapter(this,
