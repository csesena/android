...
public class Informacion extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater
				.inflate(R.layout.fragment_informacion, container, false);

		TextView tv = (TextView) rootView.findViewById(R.id.info);
		TextView tv1 = (TextView) rootView.findViewById(R.id.info1);
		TextView tv2 = (TextView) rootView.findViewById(R.id.info2);
		TextView tv3 = (TextView) rootView.findViewById(R.id.info3);
		TextView tv4 = (TextView) rootView.findViewById(R.id.info4);
		TextView tv5 = (TextView) rootView.findViewById(R.id.info5);
		TextView tv6 = (TextView) rootView.findViewById(R.id.info6);
